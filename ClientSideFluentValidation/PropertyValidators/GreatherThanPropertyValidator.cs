...
{
    public class GreatherThanPropertyValidator : ClientValidatorBase
    {
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            if (memberInfo != null)
            {
                ...
                MergeAttribute(context.Attributes, "greaterthan", GetErrorMessage(context, validator, memberInfo.Name.ToString()));
            ...
            else if (compareValue != null)
            {
                ...
                MergeAttribute(context.Attributes, "data-val-range-min", ((int)compareValue + 1).ToString());
            }
        }
