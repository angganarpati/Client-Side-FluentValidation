...
{
    public class LessThanPropertyValidator : ClientValidatorBase
    {
        public LessThanPropertyValidator(PropertyRule rule, IPropertyValidator validator) : base(rule, validator)
        {
        }
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            if (memberInfo != null)
            {
                ...
                MergeAttribute(context.Attributes, "lessthan", GetErrorMessage(context, validator, memberInfo.Name.ToString()));
            ...
            else if (compareValue != null)
            {
                ...
                MergeAttribute(context.Attributes, "data-val-range-max", ((int)compareValue - 1).ToString());
