...
{
    public class GreatherThanOrEqualPropertyValidator : ClientValidatorBase
    {
        public GreatherThanOrEqualPropertyValidator(PropertyRule rule, IPropertyValidator validator) : base(rule, validator)
        {
        }

        public override void AddValidation(ClientModelValidationContext context)
        {
            var validator = (GreaterThanOrEqualValidator)Validator;
            ...
            if (memberInfo != null)
            {
                ...
                MergeAttribute(context.Attributes, "greaterthanorequal", GetErrorMessage(context, validator, memberInfo.Name.ToString()));
